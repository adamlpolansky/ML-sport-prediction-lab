...
incumbent and append-only exploratory challenger. It contains no result,
odds row, manager or referee timeline, source cache, raw feature row, or fitted real model.
